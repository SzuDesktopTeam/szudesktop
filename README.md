...
**以下改动尚未公开发布，上方下载仍是 beta0.9.2。** 当前 beta0.9.3 源码候选新增三套可切换的三渲二首页风景，沿用草稿 [PR #19](https://github.com/SzuDesktopTeam/szudesktop/pull/19)。本轮接入与验收记录集中在 [STATUS 第 61 节](docs/STATUS.md#61-三渲二首页风景2026-09-27源码候选)。第 60 节的候选安装包和 CI 记录对应此前的 2048 素材版本。

### 换一扇窗，看见另一种荔园

首页顶部可以选择 **荔湖晴昼、雨后书屋、蓝调晚庭**，也能随时回到原来的**像素庭院**。选择会保存在本机，重新打开继续使用；伙伴、农田和待办共用原来的进度。
