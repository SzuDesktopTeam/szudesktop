...
**以下改动尚未公开发布，上方下载仍是 beta0.9.2。** 当前 beta0.9.3 候选把伙伴小桌的 2048 换成庭院自己的种子、作物、木篮和荔宝丰收礼，沿用草稿 [PR #19](https://github.com/SzuDesktopTeam/szudesktop/pull/19)。本轮针对性的 **6 组、71 项本地检查通过**；新素材与实际合并、悔棋证据集中在 [STATUS 第 60 节](docs/STATUS.md#60-2048-换上庭院素材2026-09-27源码未发布)。候选包与远端 CI 结果在该节继续补充。
