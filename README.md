...
六种伙伴（含旧存档的阿青）各有 **12 组动作、每组 6 帧，共 432 帧**独立像素画：发呆、张望、散步、摸头、吃点心、玩耍、睡觉、伸懒腰、庆祝、陪伴专注、低落和打招呼。眼睛、嘴、四肢、尾巴与叶片分别变化；主窗口和桌宠使用同一个播放器，空闲节奏因角色而异，睡眠、专注和互动会切到对应动作。小屋的「动作册」可以逐组播放、查看每一帧。另保留 30 张静态形象，用于减少动态效果和导出明信片。
