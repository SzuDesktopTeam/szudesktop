...
**以下改动尚未公开发布，上方下载仍是 beta0.9.2。** 本轮将逐帧宠物、性格台词和小游戏接成可保存进度的庭院体验。32 组界面与桌面检查、真实浏览器试玩和本地构建已通过；新增安装包的远端 CI 结果统一记录在 [STATUS 第 57 节](docs/STATUS.md#57-逐帧伙伴与庭院小游戏2026-09-27源码未发布)。下方早期首页、农田和伙伴图片属于此前候选，不代表本轮动画的验收。
