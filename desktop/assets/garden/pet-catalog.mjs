...
export const PETS={
 ...
 chestnut:{name:'栗栗',sprite:'cat',viewBox:'0 0 20 22',states:true,available:true,description:'一脸理所当然的栗色小猫，正认真看守一个空纸箱。',greeting:'喵。这个位置我试过了，可以坐。',lines:{
  pat:['嗯。手不要停。','批准你再摸两下。'],feed:['放这里就行。我一会儿吃。……现在也行。','这份归我。旁边那份我先看着。'],play:['我早就知道它会滚到那边。','刚才那一下，是计划的一部分。'],sleep:['我没有睡，只是暂时不看。','有事叫我。没事也先别叫。'],wake:['我一直在听。你刚才说到哪了？','可以开始了。先等我一下。'],focus:['做完了？我就说有我看着没问题。','这一段不错。准你休息一会儿。'],harvest:['放进篮子里。我负责看守。','清点完了。篮子里确实有东西。'],
 }},
